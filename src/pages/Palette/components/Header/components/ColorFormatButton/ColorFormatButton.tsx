        ...
        <div className="basis-1/3 flex justify-center">
            <div className="h-9 w-67.5 flex flex-col relative select-none ">
                <div
                    ...
                    className="flex relative gap-x-1 h-full bg-black rounded-item cursor-pointer items-center justify-center text-white">
                ...
                <ul
                    ...
                    {Object.values(ColorFormatEnum).map((element, index) => (
                        <li
                            ...
                            className={`h-8 hover:bg-black hover:text-white duration-200 flex items-center justify-center ${Object.values(ColorFormatEnum).length - 1 === index ? '' : 'border-b border-dark'}`}
